...
def init_params(options):
    ...
    # classifier
    params['U'] = 0.01 * numpy.random.randn(options['h2_option'][1],
...
def train_cnn(
    ...
    decay_c=1e-3,  # Weight decay for the classifier applied to the U weights.
    ...
    batch_size=2000,  # The batch size during training.
    image_width = 32, image_height=32,
    h1_option = (2049,1000, 1),
    h2_option = (1000,500, 1),
